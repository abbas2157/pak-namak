...
class OrderAdminController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = Order::with(['shop:id,name,phone_number,city,area_id', 'shop.area:id,name', 'items', 'sale:id,order_id'])
            ->orderByDesc('id');
    ...
    {
        $order->load(['shop.area', 'items', 'sale:id,order_id,sale_date,total_amount']);
